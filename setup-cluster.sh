...
project='dooshima-cicd'
profile='dooshima-cicd'
environment='local'
...
# pwsh scripts/retrieve-secrets.ps1 -Project $project -Secret 'dooshima-cicd-local' -Impersonate 'terraform-reader'

# pwsh scripts/retrieve-secrets.ps1 -Project $project -Secret 'dooshima-cicd-local'
...
minikube start --profile $profile  --memory=4096 --cpus=8
